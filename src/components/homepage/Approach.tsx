    ...
    >
      <div className="min-[1800px]:w-[1500px] max-[1800px]:w-[90%] mx-auto">
        ...
        <div>
          ...
          >
            {/* First Content Block */}
            <div ref={refOne} className="h-[150px] max-[540px]:h-[180px] mx-auto w-[90%]">
            ...
            <div className="h-[150px] max-[540px]:h-[190px] mx-auto max-[540px]:mt-4 w-[90%]">
              <ol className="flex items-start gap-[20px] relative">
                <div className="bg-white relative w-[40px] min-w-[40px] h-[40px] flex items-center justify-center rounded-full border-4 border-greenish">
                  <div className={`${'bg-[#53961E]'} w-[85%] h-[85%] rounded-full`}></div>
                  <motion.div
            ...
            <div className="h-[150px] max-[540px]:h-[190px] mx-auto w-[90%]">
              <ol className="flex items-start gap-[20px] relative">
                ...
                <div>
                  ...
                  <Texts className="max-[370px]:text-[14px]">
                    Once the strategy is refined, we create a clear, actionable plan with
                    defined timelines, resources, and goals. This phase is all about
                    turning your idea into reality and ensuring everything runs smoothly.
                  </Texts>
                </div>
              </ol>
            </div>
            ...
            <div className="h-[150px]  max-[540px]:h-[190px] mx-auto w-[90%]">
              <ol className="flex items-start gap-[20px] relative">
                ...
                <div>
                  ...
                  <Texts className="max-[370px]:text-[14px] ">
                    After execution, we continuously monitor progress and analyze results.
                    We adjust and refine the implementation, ensuring that your project
                    not only achieves its initial goals but is set up for sustainable
                    growth and success.
                  </Texts>
                </div>
              </ol>
