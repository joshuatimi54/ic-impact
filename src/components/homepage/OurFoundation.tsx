...
const OurFoundation: React.FC = () => {
  ...
  return (
    <div className="relative h-[60vh] max-[480px]:h-[100vh] max-[1200px]:min-h-screen flex flex-col justify-center items-center bg-greyish">
      <div className="relative z-[9] px-4 py-[30px] min-w-[400px] max-[500px]:min-w-[90%] min-[1800px]:w-[1500px] max-[1800px]:w-[90%] max-[1200px]:w-[60%] mx-auto h-[60%] max-[1200px]:h-auto bg-white rounded-[15px]">
        <div
          ref={refOne}
