...
const OurFoundation: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[60vh] max-h-[100vh] max-[480px]:h-[100vh] flex flex-col justify-center items-center bg-greyish">
      <div className="flex relative z-[9] px-4 py-[20px] min-w-[400px] max-[500px]:min-w-[90%] min-[1800px]:max-w-[1200px] max-[1800px]:max-w-[1100px] max-[1800px]:w-[90%] mx-auto max-[1200px]:my-[50px] bg-white rounded-[15px]">
        <div
          ref={refOne}
        ...
        >
          ...
          <div className="flex flex-col items-start justify-between gap-[10px] max-w-[400px] max-[1200px]:max-w-[70%] max-[850px]:max-w-[90%] max-[850px]:w-[90%] max-[400px]:w-[100%]">
            <Texts>
