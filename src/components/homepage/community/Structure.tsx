  ...
  return (
    <div className="max-[500px]:w-full">
      ...
      >
        <div
          className={clsx(
            `h-full max-[500px]:min-h-[250px] max-[500px]:w-full relative z-10 flex flex-col items-center justify-center mx-auto`,
        ...
        <div className="px-2 max-[500px]:px-4 max-[500px]:pb-4">
          ...
          <Texts className="max-w-[250px] max-[500px]:max-w-full mt-4">
            {text}
          </Texts>
          <Texts className="flex items-center gap-3 mt-[30px] cursor-pointer text-cyanish">
            <Link to="/community">
