...
const Pillars = () => {
  return (
    <div className="min-h-[90vh] bg-greyish flex flex-col items-center justify-center gap-[60px]">
      ...
      <div className="flex max-[950px]:flex-col items-start max-[950px]:items-center justify-between min-[1800px]:max-w-[1200px] max-[1800px]:max-w-[1100px] max-[1800px]:w-[90%] mx-auto max-[950px]:my-[0px] gap-[20px] max-[950px]:gap-[40px]">
        <Structure>
          <div>
            <div
      ...
      <Texts
        variant="custom"
        className="max-[950px]:w-[80%] max-[600px]:w-[90%] max-[950px]:mb-[50px] text-center text-[18px] font-sourceSansBold w-[50%] mt-[20px] max-[600px]:mt-0 mx-auto"
      >
